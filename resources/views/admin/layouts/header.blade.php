<div class="header">
		...
		<div class="header-logo">
			<a href="">
				<img class="large-logo" src="{{ asset('customer-assets/Images/logo.PNG') }}" alt="image">
				<img class="small-logo" src="{{ asset('customer-assets/Images/logo.PNG') }}" alt="image">
				<img class="dark-logo" src="{{ asset('customer-assets/Images/logo.PNG') }}" alt="image">
			</a>
		</div>
		<!-- end::header logo -->
		<!-- begin::header body -->
